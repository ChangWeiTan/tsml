 ...
 *
 * @author sjx07ngu
 * @article{lines15elastic, title={Time Series Classification with Ensembles of Elastic Distance Measures},
...
public class ElasticEnsemble extends AbstractClassifierWithTrainingInfo implements WritableTestResults, TrainAccuracyEstimator, TechnicalInformationHandler {
    ...
    public boolean findsTrainAccuracyEstimate() {
        return writeEnsembleTrainingFile;
    }
...
//TO DO: Write the other stats        
    ...
    /************************************************************************************************
     Checks for FastEE
     get the classifiers and compare it with FastEE
